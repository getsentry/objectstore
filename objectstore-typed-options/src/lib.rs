...
/// Logs an error against a namespace.
///
/// Called by the callback generated by `#[derive(SentryOptions)]` so that the dependency on the
/// logging facility stays in this crate rather than being forced onto every deriving crate. Not
/// intended for direct use.
#[doc(hidden)]
pub fn log_error(namespace: &str, message: &str, err: &Error) {
    objectstore_log::error!(!!err, namespace, "{message}");
}
