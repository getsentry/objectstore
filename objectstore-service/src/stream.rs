...
/// as [`ClientStream`](crate::error::ErrorKind::ClientStream), which the server
/// maps to HTTP 400 rather than 500.
///
...
/// as [`ClientStream`](crate::error::ErrorKind::ClientStream) instead of an
/// opaque server error.
