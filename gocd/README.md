# Objectstore Deployment Pipelines

The Objectstore pipelines are rendered as a
...
```sh
gocd/generate-pipelines.sh
```

This will clean, fmt, lint and generate the GoCD pipelines to
`./gocd/generated-pipelines`.

The Objectstore pipelines are using the https://github.com/getsentry/gocd-jsonnet
...
deploying Objectstore. These libraries are used to create a
